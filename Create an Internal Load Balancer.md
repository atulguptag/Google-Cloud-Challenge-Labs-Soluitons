## *Lab Name* - `Create an Internal Load Balancer [GSP216]`

## *Lab Link* - [`Click Here`](https://www.cloudskillsboost.google/focuses/1250?parent=catalog)

<!-- ## [YouTube Solution Link](To be Uploaded Soon) -->

Run the below commands in the Cloud Shell Terminal.

### Get the Zone from Task 2
